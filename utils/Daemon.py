...
__revision__ = "$Id: Daemon.py,v 1.3 2011/01/07 16:54:23 mpf Exp $"
__version__ = "0.2"
...
def createDaemon():
   ...
   devnull = os.open(REDIRECT_TO, os.O_RDWR)      # standard input (0)

   # Duplicate standard input to standard output and standard error.
   os.dup2(devnull, 0)      # standard input  (1)
   os.dup2(devnull, 1)      # standard output (2)
   os.dup2(devnull, 2)      # standard error  (3)
