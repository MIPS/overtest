# -*- encoding: utf-8 -*-
# $Id: strings.py,v 1.4 2008/02/03 17:09:35 jwp Exp $
##
...
def split_ident(text, maxsplit = -1, sep = ',', quote = '"'):
	"""
	Split a series of identifiers using the specified separater
	"""
	nr = []
