...
function checkBracketsCallback()
{
  ...
  $('perma_link').writeAttribute("href",'viewresults2.php?testsuiteid='+testsuiteid+'&search_terms='+Object.toJSON(myFilterTerms)+'&group_terms='+Object.toJSON(myGroupTerms)+'&show='+showstring);
}
...
function getResults()
{
  ...
  $('tab_link').writeAttribute("href",'viewresultsajax2.php?what=resulttable&output=tab&searchstring='+Object.toJSON(myFilterTerms)+'&groupstring='+Object.toJSON(myGroupTerms)+'&show='+showstring+'&testsuiteid='+testsuiteid);

  new Ajax.Updater('resultdiv', 'viewresultsajax2.php',
                   { method: 'post',
...
function loadTestrunInfoTooltip(testrunid)
{
  ShowTip('Loading ...');
  wait();
  new Ajax.Updater('ttip', 'viewresultsajax2.php',
                   { method: 'post',
