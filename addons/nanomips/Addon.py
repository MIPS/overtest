...
from TestConfigurations import GCCDejagnuTestConfig, GPPDejagnuTestConfig,\
			       GOLDTestConfig, GDBTestConfig, GASTestConfig,\
			       LDTestConfig, BinutilsTestConfig
...
class Addon:
  ...
  def run(self, args):
	...
	for testsuite in ["gcc", "g++", "gold", "gdb", "gas", "ld", "binutils"]:
  ...
  def getCrossBuildConfig(self, vendor, os_part):
	...
	actions['Toolchain Build'] = "Bare Metal - qemu,python"
      ...
      actions['QEMU'] = "Remote"
      actions['Python'] = "Remote"
      actions['Toolchain Build'] = "Linux - musl,qemu,python"
  ...
  def getCanadianBuildConfig(self, vendor, os_part):
    ...
    if os_part == "elf":
      ...
      actions['Toolchain Build'] = "Linux - Canadian Cross - musl,qemu,python"
