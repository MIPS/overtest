#*****************************************************************************
#
#               file : $RCSfile: MemorySetup_enhbypass2_segmmu.py,v $
#             author : $Author: ral $
...
# For MTP, allocate external mem to seg 5; sets up equivalent local mapping in seg 1
  libmodule.SegMMUSegDecl(5, '0xB0000000', '0x01000000')
  libmodule.SegMMUSegDecl(4, '0x88000000', '0x00100000')
  libmodule.SegMMUSegDecl(7, '0xFFF00000', '0x00100000')
...
# end of MemorySetup_enhbypass2_segmmu.py
